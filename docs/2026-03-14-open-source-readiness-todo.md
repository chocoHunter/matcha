...
- [ ] 增加 `CONTRIBUTING.md`（开发流程、分支规范、提交流程）
- [ ] 增加 `SECURITY.md`（漏洞报告渠道、处理 SLA）
- [ ] 增加 Issue / PR Template，减少社区沟通成本
- [ ] 增加发布文档：签名、公证、DMG 产物生成与校验步骤

## P2 - 体验与可维护性优化

- [ ] 中英文术语统一（如 Resume Sleep/恢复休眠、Lid Closed/合盖不睡）
